  ...
  return (
    <section id="meniu" className="py-20 px-4">
      <div className="container mx-auto max-w-5xl">
        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
          {items.map((item, i) => (
            <div
              ...
              className="fade-up hover-lift rounded-xl overflow-hidden bg-card border border-border"
        ...
        <div className="mt-10 flex items-center justify-center gap-3 rounded-lg bg-muted px-6 py-4 text-center">
          <Coffee className="h-5 w-5 text-secondary shrink-0" />
          <p className="text-sm font-medium text-foreground/80">
            Adaugă o cafea de specialitate la orice bagel!
          </p>
        </div>
      </div>
    </section>
