  ...
  <section id="home" className="relative min-h-screen flex items-center overflow-hidden bg-foreground">
    ...
    <div className="relative z-10 container mx-auto px-5 lg:px-8 py-32">
      <div className="max-w-2xl">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary/15 border border-primary/25 text-primary text-xs font-semibold tracking-wider uppercase mb-8">
          <span className="w-1.5 h-1.5 rounded-full bg-primary animate-pulse" />
          Deschis acum · București
        </div>

        <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-background leading-[1.05] tracking-tight mb-6">
          Gustul Autentic
          <br />
          de Bagel în Inima
          <br />
        ...
        <p className="text-background/60 text-base sm:text-lg mb-10 max-w-lg leading-relaxed">
